...
class TestCase10(unittest.TestCase):
    ...
    def test_insertion(self):
        ...
        referenced_attributes = Attributes('R10', ['x','y'])
        referencing_attributes = Attributes('S10', ['b','c'])
        expected_output = True
...
class TestCase17(unittest.TestCase):
    ...
    def test_insertion(self):
        ...
        determined_attributes = Attributes('R17', ['y'])
...
class TestCase10Negated(unittest.TestCase):
    ...
    def test_insertion(self):
        ...
        referenced_attributes = Attributes('R10N', ['x', 'y'])
        referencing_attributes = Attributes('S10N', ['e','d'])
        expected_output = False
...
class TestCase17Negated(unittest.TestCase):
    ...
    def test_insertion(self):
        ...
        determined_attributes = Attributes('R17N', ['z'])
